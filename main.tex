...
$L = 1000$, $3000$, and $10{,}000$---contributes $c_{R_3} = -1.25$, while the
...
The calculation uses 318 grid points at $L = 1000$, $3000$, and $10{,}000$.
...
Table~\ref{tab:channels} shows the result for three Richardson pairs.
...
are stable across Richardson pairs (spread $< 8\%$), confirming convergence.
