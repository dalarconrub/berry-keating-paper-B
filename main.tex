...
spacing statistics. We show below that extracting $b$ cleanly requires
...
contamination. Richardson at $(1000, 3000)$ has residual $d/1000 \approx -0.25$,
an order of magnitude cleaner.
...
$R_3^{\min} \in [0.75, 0.80]$, reproducing $98$--$99\%$ of $c_{\mathrm{emp}}$.
...
by $d/L$ residuals (Table~\ref{tab:regions}).
