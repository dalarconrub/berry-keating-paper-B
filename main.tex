...
Before arriving at the $R_3$ decomposition, we explored 34 alternative
approaches to derive $c$ from the Berry-Keating kernel. Each failure
reveals a structural insight that collectively explains why $R_3 = |K|^2$
is the only viable route. We organise them by the obstruction encountered.
